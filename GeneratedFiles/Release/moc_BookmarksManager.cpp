...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_BookmarksManager_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_BookmarksManager_t qt_meta_stringdata_BookmarksManager = {
    {
QT_MOC_LITERAL(0, 0, 16), // "BookmarksManager"
QT_MOC_LITERAL(1, 17, 10), // "shouldLock"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 11), // "shouldClose"
QT_MOC_LITERAL(4, 41, 12) // "changedColor"

    },
    "BookmarksManager\0shouldLock\0\0shouldClose\0"
    "changedColor"
};
...
void BookmarksManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->shouldLock(); break;
        case 1: _t->shouldClose(); break;
        case 2: _t->changedColor(); break;
        default: ;
        }
        ...
        {
            typedef void (BookmarksManager::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BookmarksManager::shouldLock)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (BookmarksManager::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BookmarksManager::shouldClose)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (BookmarksManager::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&BookmarksManager::changedColor)) {
                *result = 2;
                return;
            }
        }
